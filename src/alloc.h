...
# define FREE(ptr) pddlFreeCheck((ptr), __FILE__, __LINE__, __func__)
 ...
 */
#define ALLOC_ALIGN(type, align) \
    _PDDL_ALLOC_ALIGN_MEMORY(type, sizeof(type), align)

/**
 * Allocates aligned array
 */
#define ALLOC_ALIGN_ARR(type, num_els, align) \
 ...
 */
#define CALLOC_ARR(type, num_elements) \
