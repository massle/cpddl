...
#ifndef __PDDL_HPOT_OLD_H__
#define __PDDL_HPOT_OLD_H__
...
typedef struct pddl_hpot_old_config pddl_hpot_old_config_t;

#define PDDL_HPOT_OLD_CONFIG_INIT { \
        1, /* .disambiguation */ \
